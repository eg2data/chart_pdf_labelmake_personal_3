...
const dataList =  // notion > tess > report 공유하기
    {
        "basic-info": {
            "user-name": "박의근",
...
// 그래프 그릴 때는 int 그대로 사용해도 되니까 이대로 쓰면 될 것 같고.
// pdf 출력을 위해 불러올 때는 불러오는 시점에서 toString() 붙여주면 될 듯
// const testString = getData("basic-info")["company-info"]["name"]
// console.log(testString.toString())
//
// const testInt = getData("koss-sf")["signals"][0]
// console.log(testInt.toString())


// signal -> 1/2/3/4로 받는다. 이미 결정된 그것을
// 그리고서, chart 그릴 때 조건문으로 처리한다.
// 1이면 첫번째 2면 두번째 뭐 이렇게
