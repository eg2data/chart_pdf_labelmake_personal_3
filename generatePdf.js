...
generateChart()
    .then(( charts ) => {
        const inputs = [
            ...
            "overall-koss-sf-points": getData("koss-sf")["points"],
            "overall-koss-sf-rates": getData("koss-sf")["rates"],
            "overall-koss-sf-means": getData("koss-sf")["means"],
            "overall-phq-9-signals": charts['phq-9-signals'],
            "overall-phq-9-points": getData("phq-9")["points"],
            "overall-phq-9-rates": getData("phq-9")["rates"],
            "overall-phq-9-comments": getData("phq-9")["comments"],
            "overall-gad-7-signals": charts['gad-7-signals'],
            "overall-gad-7-points": getData("gad-7")["points"],
            "overall-gad-7-rates": getData("gad-7")["rates"],
            "overall-gad-7-comments": getData("gad-7")["comments"],
            "overall-adnm-4-signals": charts['adnm-4-signals'],
            "overall-adnm-4-points": getData("adnm-4")["points"],
            "overall-adnm-4-rates": getData("adnm-4")["rates"],
            "overall-adnm-4-comments": getData("adnm-4")["comments"],
            "overall-pc-ptsd-5-signals": charts['pc-ptsd-5-signals'],
            "overall-pc-ptsd-5-points": getData("pc-ptsd-5")["points"],
            "overall-pc-ptsd-5-rates": getData("pc-ptsd-5")["rates"],
            "overall-pc-ptsd-5-comments": getData("pc-ptsd-5")["comments"],
            "overall-isi-signals": charts['isi-signals'],
            "overall-isi-points": getData("isi")["points"],
            "overall-isi-rates": getData("isi")["rates"],
            "overall-isi-comments": getData("isi")["comments"],
            "overall-css-signals": charts['css-signals'],
            "overall-css-points": getData("css")["points"],
            "overall-css-rates": getData("css")["rates"],
            ...
            "phq-9-rates": getData("phq-9")["rates"],
            ...
            "gad-7-rates": getData("gad-7")["rates"],
            ...
            "adnm-4-rates": getData("adnm-4")["rates"],
            ...
            "pc-ptsd-5-rates": getData("pc-ptsd-5")["rates"],
        ...
        labelmake({ inputs, template, font })
            .then((pdf) => {
                fs.writeFileSync(__dirname + "/personal_test_1.pdf", pdf, "utf-8"); // 파일이름 등 자동으로 변경하는 방법은?
            });
    })